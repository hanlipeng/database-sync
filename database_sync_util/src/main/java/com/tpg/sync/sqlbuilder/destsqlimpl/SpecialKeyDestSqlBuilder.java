package com.tpg.sync.sqlbuilder.destsqlimpl;
...
import static com.tpg.sync.constant.FieldSpecialKeyConstant.DEST_FIELD_IGNORE;
import static com.tpg.sync.constant.FieldSpecialKeyConstant.FIELD_IGNORE;
 ...
 * @author reph
 */
public class SpecialKeyDestSqlBuilder implements SqlBuilder {
    @Override
